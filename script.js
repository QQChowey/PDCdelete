...
request.onload = function() {
	...
	for (var i = 0; i < monster.length; i++) {
		...
		newtype1.src = "http://puzzledragonx.com/en/img/type/" + monster[i]["type"] + ".png";
;
		...
		newname.innerHTML = "No." + i + '.' + monster[i]['id'] + "&nbsp;" + monster[i]['name'];
		...
		newleft.append(newdiv2);
		newdiv2.append(newtype1);
		newdiv2.append(newtype2);
		newdiv2.append(newtype3);
